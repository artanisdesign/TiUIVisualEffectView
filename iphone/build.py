...
def compile_js(manifest,config):
	js_file = os.path.join(cwd,'assets','com.artanisdesign.uivisualeffect.js')
...
""" % module_assets
	...
	assets_router = os.path.join(cwd,'Classes','ComArtanisdesignUivisualeffectModuleAssets.m')
